...
<div class="flex flex-wrap gap-4 px-4 pt-4 pb-3 shadow-sm lg:hidden bg-white text-gray-900 border-b border-[#C5A059]/20">
    <div class="flex items-center justify-between w-full">
        ...
        <div class="flex items-center gap-x-1.5">
            ...
            <a
                ...
                class="flex items-center space-x-2.5 group py-1"
                aria-label="Aniel's Perfumery"
            >
                <img src="/logomain.png" alt="Aniel's Perfumery Emblem" class="h-9 w-auto object-contain">
                <div class="flex flex-col text-left">
                    <span class="font-serif text-base font-bold tracking-[0.2em] text-[#C5A059] leading-none">ANIEL'S</span>
                    <span class="text-[7.5px] tracking-[0.35em] uppercase text-gray-500 mt-0.5">P E R F U M E R Y</span>
                </div>
            </a>
        ...
        <!-- Right Navigation -->
        <div>
            <div class="flex items-center gap-x-5 max-md:gap-x-4 text-gray-900">
...
@pushOnce('scripts')
    <script type="text/x-template" id="v-mobile-drawer-template">
            ...
            >
                ...
                <x-slot:content class="!p-0 bg-[#FAF8F5] dark:bg-[#121212] min-h-screen h-full">
    ...
    <div class="relative min-h-screen h-full overflow-y-auto bg-[#121212] text-[#FFFFF0] pb-28" style="background-color: #121212 !important;">
        <!-- Sliding container -->
            <div
                class="flex min-h-screen h-full transition-transform duration-300 bg-[#121212]"
            ...
            >
            <!-- First level view -->
            <div class="flex-shrink-0 w-full min-h-screen h-full px-6 overflow-y-auto bg-[#121212]" style="background-color: #121212 !important;">
                <div class="py-6 pb-28 space-y-4 text-sm tracking-widest uppercase font-medium bg-[#121212]" style="background-color: #121212 !important;">
                        <!-- Custom Static Links matching Reference Specification -->
                        <a href="{{ route('shop.home.index') }}" class="block py-2.5 text-[#C5A059] border-b border-[#C5A059]/20 font-serif text-base font-bold">Home</a>

                        <!-- Shop Categories Breakdown -->
                        <div class="py-2 border-b border-[#C5A059]/20">
                            <div class="flex items-center justify-between text-[#C5A059] mb-2 font-bold font-serif text-base">
                                <a href="{{ route('shop.search.index') }}">Shop All Fragrances</a>
                            </div>
                            <div class="pl-3 space-y-2 text-xs text-gray-300 normal-case tracking-normal font-sans">
                                <a href="/extrait-de-parfum" class="block py-1 hover:text-[#C5A059] transition-colors">✨ Extrait de Parfum</a>
                                <a href="/eau-de-parfum" class="block py-1 hover:text-[#C5A059] transition-colors">💎 Eau de Parfum</a>
                                <a href="/private-reserve-oud" class="block py-1 hover:text-[#C5A059] transition-colors">👑 Private Reserve Oud</a>
                                <a href="/bespoke-fragrances" class="block py-1 hover:text-[#C5A059] transition-colors">🌿 Bespoke Fragrances</a>
                            </div>
                        </div>

                        <a href="{{ route('shop.home.our_story') }}" class="block py-2.5 text-[#FFFFF0] border-b border-[#C5A059]/20 hover:text-[#C5A059] transition-colors font-serif text-base">
                            Our Story
                        </a>
                        <a href="{{ route('shop.scent_finder.index') }}" class="block py-2.5 text-[#FFFFF0] border-b border-[#C5A059]/20 hover:text-[#C5A059] transition-colors font-serif text-base">
                            Signature Scent Finder
                        </a>
                        <a href="{{ route('shop.home.index') }}#scent-journal" class="block py-2.5 text-[#FFFFF0] border-b border-[#C5A059]/20 hover:text-[#C5A059] transition-colors font-serif text-base">
                            The Scent Journal
                        </a>
                        <a href="{{ route('admin.session.create') }}" class="block py-2.5 text-[#C5A059] border-b border-[#C5A059]/20 font-serif text-base">
                            Admin Console
                        </a>

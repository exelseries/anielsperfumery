...
Route::get('why-aniels', [HomeController::class, 'whyAniels'])
    ->name('shop.home.why_aniels')
    ->middleware('cache.response');

Route::get('our-story', [HomeController::class, 'ourStory'])
    ->name('shop.home.our_story')
    ->middleware('cache.response');
...
Route::get('scent-finder', [HomeController::class, 'scentFinder'])
    ->name('shop.scent_finder.index')
    ->middleware('cache.response');

Route::post('scent-finder/recommend', [HomeController::class, 'scentFinderRecommend'])
    ->name('shop.scent_finder.recommend');
